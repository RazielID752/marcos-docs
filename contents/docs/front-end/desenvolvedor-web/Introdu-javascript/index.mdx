...
O Escopo Léxico em JavaScript significa que uma função pode acessar variáveis definidas dentro dela e também nas funções
e blocos externos onde foi declarada.

Ou seja, quando uma função é criada, ela "lembra" onde foi definida e consegue acessar variáveis 
desse local, mesmo que seja chamada em outro contexto.
